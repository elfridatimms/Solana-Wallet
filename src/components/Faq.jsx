...
const Faq = () => {
  return (
    <>
      <div className="min-h-[80vh] bg-gradient-to-b from-[#1a1b1d] to-[#3e3f43] text-white flex flex-col items-center justify-center p-6">
        {/* FAQ 1 */}
        <div className="mb-6 p-6 bg-[#313133] rounded-lg shadow-lg transition-transform transform hover:scale-105 w-full max-w-xl h-48">
