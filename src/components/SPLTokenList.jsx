  ...
  return (
    <div className="bg-[#313133] rounded-lg p-4">
      ...
      <ul className="space-y-4">
        {solBalance !== null && (
          <li className="bg-[#3d3d3f] p-4 rounded-lg flex justify-between items-center relative group">
            ...
            <button
              className="hidden group-hover:block absolute right-4 bg-[#8ecae6] text-black font-bold py-1 px-3 rounded-md hover:bg-[#219ebc] transition duration-200"
            >
              Send
            </button>
          </li>
        ...
        {tokens.length > 0 ? (
          tokens.map((token, index) => (
            <li key={index} className="bg-[#3d3d3f] p-4 rounded-lg flex justify-between items-center relative group">
              <div className="flex items-center">
                {token.logo ? (
              ...
              <button
                className="hidden group-hover:block bg-[#8ecae6] text-black font-bold py-1 px-3 rounded-md hover:bg-[#219ebc] transition duration-200 ml-4"
                >
                Send
              </button>
            </li>
